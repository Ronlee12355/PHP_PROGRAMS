...
<div class="container">
	<div class="caption">
		<h1 align="center" style="color: white;">Sign In</h1>
	</div>
	    ...
	    <div class="panel-body">
	        <form class="form-horizontal" style="margin-top: 3%;" id="pso_form">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="password" class="form-control" id="passwd" placeholder="Your password" required="required" name="passwd">
					</div>
				</div>
	        </form>
	    </div>
	   <p class="text-center"> <a href="/PSO/index.php/Home/Login/signUp">Register account</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	   	<a href="/PSO/index.php/Home/Changepd/index">Forget password</a></p>
...
<script type="text/javascript">
	var SCOPE={
		'save_url':'/PSO/index.php/Home/Login/doLogin',
		'jump_url':'/PSO/index.php/Home/Index/index',
	}
</script>
